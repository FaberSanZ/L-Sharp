...
namespace LSharp.IL.Metadata
{
    ...
    internal sealed class ResourceBuffer : ByteBuffer
    {
        ...
        {
            uint offset = (uint)this.position;
    ...
    internal sealed class GuidHeapBuffer : HeapBuffer
    {
        ...
        {
            if (guids.TryGetValue(guid, out uint index))
            {
                return index;
            }
    ...
    internal class StringHeapBuffer : HeapBuffer
    {
        ...
        {
            if (strings.TryGetValue(@string, out uint index))
            {
                return index;
            }
        ...
        {
            List<KeyValuePair<string, uint>> sorted = new List<KeyValuePair<string, uint>>(strings);
    ...
    internal sealed class BlobHeapBuffer : HeapBuffer
    {
        ...
        {
            if (blobs.TryGetValue(blob, out uint index))
            {
                return index;
            }
