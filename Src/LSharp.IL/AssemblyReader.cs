...
namespace LSharp.IL
{
    ...
    public sealed class MetadataReader : ByteBuffer
    {
        ...
        public AssemblyNameDefinition ReadAssemblyNameDefinition()
        {
            ...
            {
                HashAlgorithm = (AssemblyHashAlgorithm)ReadUInt32()
            };
        ...
        private void InitializeModuleReferences()
        {
            ...
            for (uint i = 0; i < length; i++)
            {
                ...
                {
                    token = new MetadataToken(TokenType.ModuleRef, i + 1)
                };
        ...
        private void ReadMethod(uint method_rid, Collection<MethodDefinition> methods)
        {
            ...
            {
                rva = ReadUInt32(),
                ImplAttributes = (MethodImplAttributes)ReadUInt16(),
                Attributes = (MethodAttributes)ReadUInt16(),
                Name = ReadString(),
        ...
        public IEnumerable<MemberReference> GetMemberReferences()
        {
            ...
            {
                DeclaringType = new TypeDefinition(string.Empty, string.Empty, TypeAttributes.Public)
            };
        ...
        private void InitializeImportScopes()
        {
            ...
            for (int i = 1; i <= length; i++)
            {
                ...
                {
                    token = new MetadataToken(TokenType.ImportScope, i)
                };
